...
- [TODO](#todo)
- [Hugo Clarity Theme](#hugo-clarity-theme)
  ...
  - [Getting up and running](#getting-up-and-running)
    - [Option 1a: Development in the browser](#option-1a-development-in-the-browser)
    - [Option 1b: Development on your machine](#option-1b-development-on-your-machine)
    - [Option 2: Hugo modules](#option-2-hugo-modules)
    - [Option 3: Git submodules](#option-3-git-submodules)
  - [Configuration](#configuration)
    - [Global Parameters](#global-parameters)
    - [Page Parameters](#page-parameters)
    - [Modify Menus](#modify-menus)
      - [Main Menu](#main-menu)
    ...
    - [Images](#images)
      ...
      - [Support for modern image formats](#support-for-modern-image-formats)
      - [Image captions](#image-captions)
      - [Adding figure positions to image captions](#adding-figure-positions-to-image-captions)
      - [Example of image with figure positions added](#example-of-image-with-figure-positions-added)
      ...
      - [Float images to the right](#float-images-to-the-right)
      - [Float images right example](#float-images-right-example)
      - [Round borders for images](#round-borders-for-images)
      - [Round borders for images example](#round-borders-for-images-example)
      - [Add classes to images](#add-classes-to-images)
      - [Image classes example](#image-classes-example)
    ...
    - [Hooks](#hooks)
    - [Comments](#comments)
      - [Utterances Commenting Support](#utterances-commenting-support)
    - [Math notation](#math-notation)
      - [MathJax](#mathjax)
    - [Related Content](#related-content)
    - [Maps](#maps)
      - [Creating and including a map](#creating-and-including-a-map)
      - [Options](#options)
    - [Search](#search)
